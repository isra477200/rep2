# RedVitalia · Captar despachos de abogados

Edición: 13/09/2026 · España · Manual comercial y de entrega

Especialidad: Segunda Oportunidad · Zona: [Ciudad o provincia por elegir]

Este material propone un proceso para validar. No garantiza clientes. Los textos entre corchetes requieren datos reales; las imágenes son ilustrativas. No se han enviado mensajes ni activado campañas desde este apartado.

## Perfil elegido
Despachos con práctica acreditada en insolvencia de particulares y autónomos, atención comercial y capacidad para abrir nuevos expedientes.

Pagan por consultas que no encajan o no llegan a atender; cuesta saber qué captación termina en expediente.

Enfoque: Filtro inicial, respuesta y trazabilidad hasta expediente aceptado.

## Filtro específico
- Provincia y modalidad de atención.
- Particular o autónomo y motivo general de la consulta.
- Situación general, urgencia y si existe asesoramiento previo, solo en conversación privada.
- Encaje jurídico y documentación: los valora un abogado, no un formulario automático.

- No usar cancelación total, resultado garantizado o plazos judiciales cerrados.
- No pedir extractos bancarios, DNI ni documentos de deudas en la landing.
- No decidir elegibilidad a partir de una cifra de deuda.

## Búsquedas del despacho
- abogado segunda oportunidad [zona]
- despacho segunda oportunidad [zona]
- consulta abogado insolvencia particular

## 01 · Elegir y ofrecer: Una especialidad, una zona, una oferta comprensible

El cliente de RedVitalia es el despacho. El primer producto es un piloto medible de captación, con una especialidad por campaña. España es el mercado de partida; elige una ciudad o provincia antes de prospectar.

1. Empieza con Segunda Oportunidad solo si el despacho puede acreditar esa práctica. Cambia a herencias o divorcios cuando el encaje real sea mejor.
...
5. Propuesta de valor: ayudar a identificar dónde se pierden las consultas y construir un camino hasta el asunto aceptado. La hipótesis comercial debe validarse con el piloto.

Paso terminado cuando: Elegida la especialidad y zona; anotados servicio, capacidad, coste y alcance de la oferta.

### La oferta en 30 segundos · Presentación

Uso: Para explicar qué comprará el despacho.
...
## 02 · Encontrar despachos: Una lista corta con motivos reales para llamar

Construye una primera cohorte de 30 despachos. Es una carga de trabajo propuesta, no una previsión de ventas. Dedica 5–8 minutos a comprobar cada uno y prioriza los 10 con mejor encaje.

1. Busca en Google y Maps: «abogado Segunda Oportunidad [Ciudad o provincia]», «despacho Segunda Oportunidad [Ciudad o provincia]». Completa con directorios profesionales públicos para comprobar identidad, y con webs de los despachos para teléfono y actividad.

2. Registra URL y fecha, especialidad visible, zona, teléfono profesional, responsable si es público, canal, observación verificable y siguiente acción. No inventes ingresos, presupuesto o tamaño por apariencia de la web.

3. Puntúa 0–2 cada criterio: especialidad acreditable, claridad de servicio, señal de captación activa, oportunidad concreta de mejora y accesibilidad del responsable. 8–10: llamar primero; 5–7: investigar; 0–4: aparcar. Desconocido vale 0 hasta confirmarlo.

4. Señales útiles: anuncios activos observados, landing por especialidad, formulario con demasiados campos, falta de siguiente paso claro o CTA poco visible en móvil. Una web bonita o un anuncio activo no prueban rentabilidad.

5. Antes de llamadas comerciales, documenta base de legitimación, origen profesional y pertinencia del servicio. Comprueba oposición y sistemas de exclusión aplicables. Si no está resuelto, empieza por solicitudes entrantes, referencias autorizadas o contactos que hayan pedido información.

6. Detén el contacto si rechazan, piden baja o no hay encaje. Mantén una lista mínima de exclusión para evitar repetir llamadas. Un email público no autoriza una secuencia comercial.

Paso terminado cuando: 30 fichas revisadas, 10 priorizadas y origen/legitimación del contacto documentados.

## 03 · Preparar el diagnóstico: Lleva una observación, una pregunta y una mejora

La oferta de entrada es un diagnóstico breve de captación. Debe existir antes de afirmar que has revisado la web. No envíes un PDF genérico con el nombre cambiado.

1. Abre la landing desde móvil y escritorio. Anota URL, fecha y captura de la pantalla donde se ve el problema. No envíes formularios reales fingiendo ser un posible cliente.

2. Revisa seis elementos: promesa específica, especialidad/zona, credenciales comprobables, llamada a la acción, fricción del formulario y explicación del paso posterior.

3. Prepara tres observaciones como máximo: hecho visible, posible consecuencia a validar y cambio propuesto. «No vi un plazo de respuesta» es verificable; «perdéis el 40 % de los clientes» no lo es.

4. Compara con dos páginas del archivo para explicar mecanismos, sin copiar sus promesas. Enseña una maqueta o recorrido de ejemplo etiquetado como demostración si falta acceso a datos reales.

5. Termina con una sola decisión: dedicar 20 minutos a conocer cómo se atienden hoy las consultas. Separa lo observado de lo que solo el despacho puede confirmar.

Paso terminado cuando: Mini diagnóstico de una página con pruebas visibles y pregunta específica.

### Mini diagnóstico que entregar · Documento

Uso: Completa solo con observaciones que hayas comprobado.
...
Conectar la solicitud de Segunda Oportunidad con un responsable, un filtro acordado y un siguiente paso visible. Antes de cambiar campañas, revisaríamos la recepción y el registro del estado de cada consulta.
...
### Guion de vídeo de 90 segundos · Vídeo
...
## 04 · Llamar y cualificar: Conseguir una conversación útil con quien decide

Objetivo de la primera llamada: confirmar encaje y acordar el siguiente paso. Usa el guion como conversación; escucha y recoge las palabras exactas del despacho.

1. Identifícate, di que es una propuesta comercial y ofrece oposición al inicio. Si hay interés, pide permiso para una pregunta breve.

2. Pregunta por especialidad, capacidad y atención. No intentes cerrar el servicio sin hablar con quien decide y conocer los números.

3. Si responde recepción, pide la función responsable, no datos personales innecesarios. Si no es momento, ofrece una devolución acordada.

4. Para enviar información, confirma dirección, contenido solicitado y si acepta un seguimiento. Registra fecha y alcance; no metas al contacto automáticamente en una newsletter.

5. Rutina propuesta: bloque diario de 60–90 minutos con hasta 10 fichas preparadas, registro inmediato y una próxima acción. Ajusta el volumen a la calidad y las restricciones de contacto.

Paso terminado cuando: Llamada registrada con encaje, oposición o permiso, responsable y siguiente acción.

### Recepción o centralita · Llamada
...
### Primera llamada al socio · 2 minutos · Llamada
...
[Si acepta]
Trabajamos el recorrido de las consultas por especialidad: qué entra, cómo se filtra, quién responde y qué termina en asunto aceptado. Para Segunda Oportunidad, suele ser útil revisar ese recorrido antes de aumentar la inversión.
...
### Apertura cuando ya has revisado su web · Llamada

Uso: Sustituye el bloque central; no afirmes auditoría si no existe.

He revisado la página de [Nombre del despacho] y he visto algo concreto: [Observación real de su web]

No sé todavía cómo afecta a las consultas, porque eso requiere vuestros datos. La pregunta es: cuando alguien pide información sobre Segunda Oportunidad, ¿qué recorrido sigue hasta hablar con el abogado?
...
### «No tengo tiempo» · Respuesta

Uso: Respeta el momento, ofrece una opción y termina.

Entiendo. ¿Prefieres que acordemos una llamada breve en otro momento o que dejemos aquí el contacto?
...
### Las seis preguntas de encaje · Guía

Uso: Distribúyelas en la conversación; no lo conviertas en interrogatorio.

1. ¿Qué asuntos de Segunda Oportunidad os interesa asumir y cuáles preferís descartar?
...
## 05 · Correo y seguimiento: Continuar solo la conversación que han aceptado

El correo de interesados resume lo hablado y permite responder con facilidad. Todos los envíos de esta biblioteca son manuales; el apartado no manda mensajes.

1. Día 0: envía lo pedido en la llamada y el diagnóstico si realmente está preparado. Una sola llamada a la acción.

2. Día 2–3: si aceptaron seguimiento y no contestaron, pregunta si tiene sentido revisar el diagnóstico. No añadas más archivos sin necesidad.

3. Día 6–7: aporta una idea concreta ligada a su web. Usa la variante de cierre si no hay interés o no se acordaron más contactos.

4. Día 10: cierra el seguimiento si seguía autorizado y no hay respuesta. Después, archiva. Si fijaron otra fecha, respétala en vez de esta cadencia.

5. WhatsApp solo cuando lo han elegido para esta conversación. Los recordatorios de cita se limitan a la cita solicitada. Ante oposición, cancela toda la secuencia.

Paso terminado cuando: Información solicitada enviada y próxima fecha acordada, o seguimiento cerrado.

### Correo después de mostrar interés · Correo

Uso: Envíalo cuando hayan solicitado esta información.

Asunto: [Nombre del despacho] · propuesta para la captación de Segunda Oportunidad

Hola, [Nombre de quien decide]:

Gracias por la conversación. Como me has pedido, te resumo la propuesta de RedVitalia para [Nombre del despacho].
...
### Entrega del diagnóstico preparado · Correo

Uso: Adjunta el diagnóstico real o incluye un enlace revisado.

Asunto: El diagnóstico de [Nombre del despacho] que me pediste

Hola, [Nombre de quien decide]:

Te envío el diagnóstico que acordamos: [Enlace al diagnóstico preparado]

La observación principal es esta: [Observación real de su web]

Hemos separado lo que se ve en la página de lo que necesitamos confirmar con vosotros. El primer punto que revisaríamos es cómo pasa una solicitud de Segunda Oportunidad a una conversación atendida y una cita.
...
### Día 2–3 · una pregunta fácil · Correo

Uso: Solo dentro del seguimiento que aceptaron.

Asunto: ¿Revisamos la captación de [Nombre del despacho]?

Hola, [Nombre de quien decide]:

Retomo una vez la información que me pediste sobre Segunda Oportunidad. Para saber si tiene sentido avanzar, me basta con confirmar algo: ¿tenéis capacidad para atender nuevos asuntos de esta especialidad en este momento?
...
### Día 6–7 · aportar una idea · Correo

Uso: Úsalo si existe la observación y sigue permitido el seguimiento.

Asunto: Una mejora concreta para las consultas de Segunda Oportunidad
...
En la página revisada observamos: [Observación real de su web]
...
### Día 10 · cerrar sin presionar · Correo

Uso: Último mensaje del seguimiento aceptado, si no hubo oposición.

Asunto: Cierro el seguimiento de [Nombre del despacho]

Hola, [Nombre de quien decide]:

Cierro por ahora el seguimiento de la propuesta de captación para Segunda Oportunidad, para no seguir interrumpiéndote.
...
Uso: Después de acordar fecha y hora reales.

Asunto: Confirmado · diagnóstico de [Nombre del despacho] · [Fecha, hora y zona horaria de reunión]

Hola, [Nombre de quien decide]:

Confirmamos nuestra reunión de 20 minutos para [Fecha, hora y zona horaria de reunión].
Acceso: [Enlace de reunión]

Revisaremos la captación de Segunda Oportunidad, la atención de consultas y si encaja un piloto. Si puedes, ten a mano cifras aproximadas del último mes: consultas, citas y asuntos aceptados. No necesitamos datos personales ni documentación de vuestros clientes.
...
Uso: Una propuesta de reprogramación; no culpar ni perseguir.

Asunto: ¿Reprogramamos la revisión de [Nombre del despacho]?

Hola, [Nombre de quien decide]:

No hemos podido coincidir en la reunión. Si sigue siendo útil revisar la captación de Segunda Oportunidad, dime qué momento te viene mejor y buscamos otra hora.
...
Reunión de diagnóstico de 20 minutos: 2 para contexto, 8 para entender el proceso, 5 para la propuesta y 5 para una decisión. Los números desconocidos se apuntan como pendientes.

1. Invita al socio o responsable con capacidad de decisión; suma a quien atiende llamadas si su intervención es necesaria.

2. Recorre el último mes: consultas, válidas, contactadas, citas, asistencias, asuntos aceptados y honorarios efectivamente cobrados. Trabaja con agregados, sin expedientes ni nombres de clientes.

3. Pregunta cuánto trabajo nuevo pueden asumir y qué plazo real de respuesta pueden sostener. Marca un objetivo operativo de respuesta en horario atendido; fuera de horario, confirmación con expectativa realista.

4. Muestra un único cuello de botella. Si falta medición, el primer entregable es medir; si no hay capacidad de atención, no tiene sentido aumentar inversión todavía.

5. Cierra con una de tres salidas: propuesta con fecha de decisión, tarea concreta para resolver una duda, o no encaja. Evita reuniones sin dueño ni fecha.

Paso terminado cuando: Decisor, capacidad, cuello de botella y próximo acuerdo identificados.

### Reunión de diagnóstico · 20 minutos · Reunión

Uso: Guion completo para conducir la conversación.
...
SITUACIÓN · 4 minutos
¿Qué os ha hecho plantearos mejorar la captación ahora? ¿Qué asuntos de Segunda Oportunidad os interesan? ¿Cuáles descartáis y por qué? ¿Qué parte de vuestra capacidad está disponible?
...
Lo que entiendo es [resumen con sus palabras]. El primer punto a resolver sería [un cuello de botella]. Propondría [cambio concreto], medir [indicador] y revisar [fecha]. En Segunda Oportunidad, el criterio de aceptación lo fija vuestro abogado.
...
### «Ya trabajamos con una agencia» · Objeción

Uso: No desacredites al proveedor actual.

Tiene sentido. ¿Tenéis visible qué consultas llegan a convertirse en citas y asuntos aceptados?
...
### «Ya probamos y los contactos eran malos» · Objeción

Uso: Pide ejemplos agregados y criterios.

Entiendo la preocupación. Para distinguir el problema, ¿eran personas fuera de vuestra especialidad o zona, datos que no funcionaban, consultas sin intención o personas a las que no se llegó a contactar?
...
Uso: Aclara de qué coste habla y comprueba economía.
...
Uso: Distingue trabajo controlable de resultado comercial.

Podemos comprometernos al alcance, la medición, el seguimiento y las revisiones acordadas. El número de asuntos depende también de la demanda, la competencia, vuestro encaje jurídico y la atención.
...
### «¿Tenéis resultados en despachos?» · Objeción

Uso: No confundir investigación de competidores con experiencia propia.

Te enseñaré únicamente los resultados propios que podamos acreditar y compartir. La investigación del sector nos ayuda a preparar el método, pero no la presentamos como casos de éxito de RedVitalia.
...
### «¿Seríamos exclusivos?» · Objeción

Uso: Aclara contacto propio y territorio.

Podemos estructurar la captación desde vuestras cuentas y para vuestro despacho, sin revender esas consultas. La exclusividad territorial es otra condición: habría que acordar especialidad, zona, duración y alcance. No te la daría por hecha antes de dejarlo escrito.

### «Tengo que hablarlo con mi socio» · Objeción

Uso: Facilita una decisión compartida.

Claro. ¿Qué necesitará valorar tu socio: presupuesto, carga de atención, condiciones o cómo se mediría?
...
### «Me lo tengo que pensar» · Objeción

Uso: Descubre la duda sin presionar.

Por supuesto. Para que puedas valorarlo, ¿qué parte queda menos clara: el alcance, los números o el momento?
...
## 07 · Proponer y cerrar: Un piloto con límites y responsabilidades por escrito
...
3. Distingue consulta válida, cita agendada, cita asistida y asunto aceptado con encargo confirmado. El despacho decide el encaje jurídico y conserva su independencia.

4. Incluye alcance, revisiones, calendario tras accesos, propiedad de cuentas, salida, entrega de activos y costes de terceros. No cierres permanencia, gratuidad o exclusividad si no están expresamente pactadas.

5. La exclusividad de un contacto captado para el despacho no equivale a exclusividad territorial. Esta última requiere territorio, especialidad, duración y capacidad acordados.

6. Antes de cobrar o activar inversión, obtén aceptación del alcance y presupuesto final por quien tiene facultad. El resumen comercial sirve de base; no sustituye al contrato de servicios.

Paso terminado cuando: Alcance, honorarios, medios, condiciones y aceptación registrados.

### Correo después del diagnóstico · Correo

Uso: Completa el acuerdo; no atribuyas aceptación donde no la hubo.

Asunto: Lo acordado para [Nombre del despacho] y siguiente paso
...
• Especialidad y zona: Segunda Oportunidad en [Ciudad o provincia].
...
### Propuesta comercial completa · Documento

Uso: Base para personalizar y aceptar antes de activar el servicio.

PROPUESTA DE PILOTO · REDVITALIA × [Nombre del despacho]
Especialidad: Segunda Oportunidad · Mercado: [Ciudad o provincia]
...
### Pedir una decisión clara · Llamada

Uso: Con alcance y números ya presentados.

Hemos concretado el servicio, el coste y qué tiene que aportar cada parte. ¿Hay algún punto que impida decidir si empezamos el piloto?
...
## 08 · Landing de RedVitalia: La página que convence al socio del despacho

Esta landing vende RedVitalia a despachos. El formulario pide datos profesionales mínimos y una conversación de diagnóstico. Los bloques siguientes son el texto íntegro para construirla.

1. Orden recomendado: propuesta clara → problema reconocible → recorrido de trabajo → entregables → a quién encaja → método y prueba → precio → preguntas → formulario.

2. Usa un solo CTA: «Solicitar diagnóstico de captación». En móvil, mantenlo accesible sin tapar contenido. Confirma recepción y el siguiente paso después del envío.

3. Prueba que puedes enseñar hoy: muestra de diagnóstico, recorrido de demo, criterios de consulta válida y ejemplo de informe marcado como ejemplo. Añade casos reales solo con datos comprobables y permiso.

4. Evita logotipos de clientes no autorizados, contadores de plazas sin capacidad real, testimonios inventados y promesas de facturación.

5. La colección HTML ya incluye la landing de RedVitalia con WhatsApp y tres modelos de especialidad. Abre «Explorar las landings». Completa la identidad legal y la medición antes de campañas; los modelos de despachos mantienen la captación desactivada hasta asignar cliente.

Paso terminado cuando: Texto de la landing adaptado, pruebas reales y recorrido del formulario definidos.

### Landing completa · RedVitalia para abogados · Landing

Uso: Copia base. Adaptar los datos pendientes antes de construirla.
...
SUBTÍTULO
En RedVitalia conectamos captación, filtro y seguimiento para que tu despacho pueda saber qué consultas de Segunda Oportunidad avanzan y dónde se detienen.
...
Para despachos con práctica en Segunda Oportunidad, capacidad para nuevos asuntos y una persona responsable de atender y registrar las consultas. Antes de invertir, comprobamos que la propuesta encaja con vuestro servicio y economía.
...
Creativos B2B originales generados para RedVitalia: seguimiento de consultas y medición hasta asunto aceptado. Las imágenes son ilustrativas, no fotografías del equipo ni de clientes.

1. Primero valida la oferta en conversaciones. Después plantea una prueba pagada con un presupuesto propio de captación de RedVitalia, separado del dinero que los despachos invierten para captar sus clientes.

2. Prueba A: continuidad de atención. Prueba B: visibilidad del proceso. Usa la misma oferta y landing para saber qué cambia; evita modificar creatividad, precio y público a la vez.

3. Mide formulario profesional válido, reunión asistida y despacho contratado. El CTR solo ayuda a diagnosticar el anuncio.

4. Para Google B2B, usa intención de contratar marketing para abogados; excluye búsquedas de abogados para particulares. Para campañas del despacho, usa las búsquedas de su especialidad y una cuenta separada.

5. Antes de anunciar, revisa las políticas vigentes de la plataforma para audiencia, datos y anuncios jurídicos. Los públicos, presupuesto, destino y seguimiento están por configurar; no hay campañas activadas desde este módulo.
...
Uso: Útil para perfil o página de RedVitalia, sin fingir resultados.

Una consulta jurídica no es todavía un cliente.
...
Uso: Solo a una relación existente y cuando sea pertinente.
...
La buena venta prepara la entrega. Pide accesos por invitación, reúne las aprobaciones del despacho y ensaya el recorrido de una consulta antes de invertir.

1. Día de aceptación: contrato y alcance, persona responsable, facturación, agenda y permisos. Invita a cuentas de Google Ads, analítica y web con roles mínimos; nunca pidas contraseñas en correo.

2. Preparación: landing por especialidad, campañas separadas, CRM y agenda acordados, horarios, mensajes, política de datos y responsable de revisión jurídica.

3. Define quién atiende, quién sustituye, cuándo se escala una consulta y qué se registra. El formulario de marketing recoge mínimos; el despacho recibe documentación jurídica por sus canales.

4. Prueba con datos ficticios identificados: formulario → recepción → aviso → responsable → cita → recordatorio → estado final. Excluye estas pruebas de métricas y conversiones.

5. Antes de publicar, el abogado revisa texto, identidad profesional y afirmaciones jurídicas; verifica medición y consentimiento aplicable. Ningún evento publicitario debe contener relato del asunto o datos sensibles.

6. Primera semana activa: revisión de búsquedas y calidad. Semana 2: llamada de seguimiento y citas. Semana 3: asuntos aceptados y razones de descarte. Semana 4: decisión según costes, calidad y capacidad, no solo número de contactos.

Paso terminado cuando: Accesos, revisiones, atención y prueba del recorrido completados.

### Correo de bienvenida tras aceptar · Correo

Uso: Solo cuando el alcance esté aceptado.

Asunto: Arranque del piloto de [Nombre del despacho] · próximos pasos

Hola, [Nombre de quien decide]:

Gracias por confirmar el alcance. Empezamos la preparación del piloto de Segunda Oportunidad en [Ciudad o provincia].
...
Uso: Con comercial, atención y responsable jurídico.

0–10 min · Confirmar servicio
...
### Informe semanal al despacho · Correo

Uso: Usa datos reales; «sin dato» nunca se convierte en cero.

Asunto: [Nombre del despacho] · revisión semanal de Segunda Oportunidad · [periodo]
...
Uso: Tras el periodo acordado, considerando el retraso de cierre.

1. Qué se ejecutó frente al alcance y qué quedó pendiente.
...
## 11 · Embudo del despacho: Los textos para atender a sus futuros clientes

Este bloque es para el cliente del despacho, no para vender RedVitalia. Cambia con la especialidad seleccionada. El equipo jurídico valida y completa identidad, condiciones y privacidad antes de usarlo.

1. Anuncio de intención → landing del servicio → solicitud mínima → llamada de encaje → consulta reservada → asistencia → asunto aceptado o motivo de descarte.

2. Formulario mínimo: nombre, teléfono o correo, provincia, motivo general y preferencia de contacto. Explica responsable, finalidad y acceso a información de privacidad en la implementación.

3. Reserva la documentación y el detalle del caso para un canal seguro del despacho. No los uses en píxeles, herramientas de anuncios, diagnósticos públicos o este panel.

4. Aclarar si la primera toma de contacto y la consulta jurídica tienen coste, duración y condiciones antes de reservar. No llamar gratuita a una consulta si no está acordado.

5. La persona de atención organiza; el abogado asesora y decide viabilidad. Evita respuestas automáticas que prometan un resultado jurídico.

Paso terminado cuando: Textos del despacho revisados, condiciones de consulta definidas y circuito de atención probado.

### Landing del despacho · especialidad elegida · Landing del despacho

Uso: Revisión del abogado y condiciones completas antes de publicarla.

[Nombre del despacho] · Segunda Oportunidad en [Ciudad o provincia]

Valora tus opciones de Segunda Oportunidad con un abogado

Explica de forma general qué necesitas. El despacho revisará si puede atender tu consulta y te indicará el siguiente paso. La viabilidad depende del caso y de su valoración jurídica.
...
GRACIAS
Hemos recibido tu solicitud. El equipo de [Nombre del despacho] contactará por el canal indicado dentro de [plazo que pueda cumplir]. Si necesitas corregir un dato, utiliza [canal oficial del despacho]. Este formulario no presta atención urgente ni sustituye asesoramiento jurídico.

### Llamada a quien pide información al despacho · Llamada del despacho

Uso: La persona ha solicitado contacto. No dar asesoramiento desde marketing.

Hola, ¿hablo con [nombre de la persona]? Soy [persona de atención], de [Nombre del despacho]. Nos has pedido información sobre Segunda Oportunidad. ¿Es un buen momento y un canal adecuado para hablar?
...
### Confirmación de consulta jurídica · Mensaje del despacho

Uso: Canal elegido por la persona interesada.

Hola, [nombre]. Confirmamos tu consulta con [Nombre del despacho] para [día, hora y zona horaria].
...
Gracias, [persona de atención] · [Nombre del despacho].

### Solicitud recibida, sin contacto todavía · Mensaje del despacho

Uso: Solo para responder a la solicitud por canal apropiado.

Hola, [nombre]. Soy [persona de atención], de [Nombre del despacho]. Hemos recibido tu solicitud de contacto y no hemos podido hablar contigo. ¿Qué horario y canal te vienen bien? Si ya no necesitas que contactemos, dínoslo y cerramos la solicitud. Gracias.

### Correo después de la consulta del abogado · Correo del despacho

Uso: El abogado completa servicio y condiciones reales.

Asunto: Propuesta de servicios de [Nombre del despacho]
...
[Profesional responsable] · [Nombre del despacho]

## 12 · Plan, CRM y métricas: Saber qué hacer mañana y qué corregir después

El plan de 30 días es una agenda de ejecución, no una garantía de contratación. El control B2B de RedVitalia y el embudo B2C del despacho tienen métricas diferentes.

1. Días 1–2: elige zona/especialidad, concreta oferta y prepara tres mini diagnósticos. Días 3–5: termina 30 fichas y prioriza 10.

2. Días 6–10: contactos pertinentes, registro de respuestas y envío solicitado. Revisa qué frase abre conversación y cuál confunde; cambia una variable cada vez.

3. Días 11–15: reuniones con decisores y propuestas con fecha. Si no hay reuniones, corrige selección y mensaje antes de comprar más tráfico.

4. Días 16–20: seguimiento acordado, resolución de dudas y aceptación de alcances. Si hay interés pero no firma, revisa riesgo percibido, presupuesto y persona que decide.

5. Días 21–30: arranca los pilotos aceptados. Si todavía no hay ventas, revisa datos y conversaciones; no presentes el calendario como resultado cumplido.

6. CRM de RedVitalia: investigado → contacto permitido → conversación → interesado → diagnóstico reservado → asistió → propuesta → ganado/perdido. Cada fila tiene responsable, siguiente acción y fecha; oposición es un bloqueo.

7. Cada viernes: revisa tasas con sus denominadores, esfuerzo comercial total y margen de la gestión. Mantén un único cuello de botella prioritario por semana.

Paso terminado cuando: Agenda de la semana y tablero con próximos pasos actualizados.

### Estados y campos del CRM comercial · Operativa

Uso: Para configurar el tablero de RedVitalia.

UN REGISTRO POR DESPACHO
...
### Cómo medir la venta de RedVitalia · Operativa

Uso: Cifras de adquisición de despachos, separadas de las de sus clientes.

Conversación: conversaciones con persona relevante / intentos de contacto válidos.
...
### Ejemplo numérico del despacho · Ejemplo
...
## Qué aprovechamos del panel

### Eximia Studio · Web consultada · 13/09/2026

Observación: Landing jurídica con diagnóstico, proceso, preguntas y una promesa de exclusividad territorial.

Aplicación propuesta: Una página específica para despachos, diagnóstico tangible y explicación del recorrido.

Límite: Sus casos y compromisos pertenecen al anunciante. RedVitalia debe acreditar los propios y pactar cualquier exclusividad.

Fuente: https://eximiastudio.com/servicios/agencia-marketing-para-abogados/

### NDE Marketing · Web consultada · 13/09/2026

Observación: Adaptación del mensaje por plaza jurídica y servicios; combina captación con web y seguimiento.

Aplicación propuesta: Personalizar por ciudad y especialidad, y separar la causa observable del resultado por confirmar.

Límite: Las cifras de facturación y garantías publicadas son afirmaciones del anunciante; no se trasladan a nuestra oferta.

Fuente: https://ndemarketing.com/agencia-marketing-juridico-espana/

### Expiey · Web consultada · 13/09/2026

Observación: Presenta seguimiento de contactos, revisiones periódicas y una garantía ligada a contactos cualificados.

Aplicación propuesta: Definir qué es una consulta válida y quién responde; convertir seguimiento y revisión en entregables.

Límite: La garantía comercial observada no demuestra rendimiento ni obliga a ofrecerla en RedVitalia.

Fuente: https://expiey.com/agencia-marketing-abogados/

### Lexiuris Marketing · Archivo del panel · 21/08/2026

Observación: La ficha recoge landings por especialidad/ciudad y una entrada mediante diagnóstico.

Aplicación propuesta: Un mensaje y filtro propios para Segunda Oportunidad, herencias y divorcios.

Límite: La web presentó verificación automática en esta revisión; la evidencia aquí procede del archivo.

Fuente: https://lexiurismarketing.com/

### Nexo Jurídico · Archivo del panel · 26/08/2026

Observación: Mensaje específico para despachos de insolvencia empresarial, apoyado en un vídeo y reuniones.

Aplicación propuesta: Nombrar el tipo de asunto y el interlocutor, y explicar el mecanismo con un vídeo breve.

Límite: Es un segmento distinto de insolvencia de particulares. Su promesa de reuniones no es un resultado verificado para nuestro piloto.

Fuente: https://vsl.nexo-juridico.com/optin-vsl

### PlusLeads · Archivo del panel · 21/08/2026

Observación: El archivo describe un escaneo de potencial de mercado como oferta de entrada.

Aplicación propuesta: Entregar una revisión concreta antes de pedir una reunión comercial.

Límite: La revisión debe estar hecha y mostrar evidencia; no basta con llamar diagnóstico a una llamada de venta.

Fuente: https://plusleads.nl/

### SCALE Lead · Archivo del panel · 21/08/2026

Observación: La ficha distingue concertación de reuniones, calidad y revisión de la actividad comercial.

Aplicación propuesta: Medir reserva, asistencia y resultado por separado; usar motivos de pérdida para mejorar el guion.

Límite: No adoptamos tarifas, ratios ni condiciones de otro mercado.

Fuente: https://scale-group.co.jp/scale-lead

## Fuentes y criterios de uso

[Base del panel: nicho abogados](https://redvitalia.srv1480016.hstgr.cloud/data/nichos/legal.json) · Priorización y tarifa de gestión existentes. La tarifa no acredita que toda la infraestructura esté incluida.

[Precios y patrones de RedVitalia](https://redvitalia.srv1480016.hstgr.cloud/data/nichos/index.json) · Importes de referencia del panel: honorarios netos, IVA y medios separados.

[AEPD · llamadas comerciales](https://www.aepd.es/preguntas-frecuentes/5-publicidad-no-deseada/FAQ-0503-llamadas-no-solicitadas-con-fines-comerciales-con-intervencion-humana) · Revisar legitimación antes de llamar; identificar propósito comercial y permitir oposición desde el inicio.

[AEPD · contacto profesional](https://www.aepd.es/preguntas-frecuentes/5-publicidad-no-deseada/FAQ-0506-recepcion-de-llamadas-publicitarias-si-soy-un-empresario-individual-o-un-profesional-liberal) · La condición profesional exige pertinencia con la actividad; no habilita un uso privado o indiscriminado del contacto.

[BOE · LSSI, artículo 21](https://www.boe.es/buscar/act.php?id=BOE-A-2002-13758#a21) · Esta secuencia parte de información solicitada o autorizada, conserva el alcance y permite cerrar el seguimiento. Un email publicado no equivale a autorización.

[BOE · Estatuto de la Abogacía, artículo 20](https://www.boe.es/buscar/act.php?id=BOE-A-2021-4568) · Publicidad veraz, secreto profesional y especialización acreditable. Evitar promesas jurídicas fuera del control profesional y referencias a clientes sin autorización.

## Creativos originales

Generados con el modelo de imagen integrado (habilidad imagegen), 13/09/2026. Ilustraciones publicitarias B2B, no instalaciones ni clientes reales. Destino y campañas pendientes de configurar.

Creativo A: https://redvitalia.srv1480016.hstgr.cloud/abogados/creativo-seguimiento.png

Creativo B: https://redvitalia.srv1480016.hstgr.cloud/abogados/creativo-recorrido.png