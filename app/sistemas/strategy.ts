...
export const STRATEGY: Record<string, NicheStrategy> = {
  ...
  auditivos: {
    ...
    subsegments: [
      ...
      { name: "Productos pequeños", priority: "P3", why: "Bajo margen para adquisición fría; solo cross-sell o SEO.", entry: "Producto, usuario, zona y oportunidad de venta cruzada." },
    ],
  ...
  logistica: {
    ...
    subsegments: [
      ...
      { name: "Pequeños portes", priority: "P3", why: "Alta demanda y bajo margen; campaña separada o descartada.", entry: "Origen, destino, fecha, volumen y precio mínimo admisible." },
    ],
