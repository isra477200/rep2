        ...
        <main className={styles.main}>
          ...
          <section className={styles.clientBrief} data-compact={activeStage !== "Preparar"} aria-labelledby="client-brief-title">
            ...
            <div className={styles.approvalChecks}>
              <label aria-label="Claims y pruebas aprobados" htmlFor="sector-claims-approved" data-checked={brief.claimsApproved}><input id="sector-claims-approved" type="checkbox" checked={brief.claimsApproved} onChange={(event) => updateBrief("claimsApproved", event.target.checked)} /><span><b>Claims y pruebas aprobados</b><small>Ninguna cifra, reseña o resultado inventado.</small></span></label>
              <label aria-label="Privacidad preparada" htmlFor="sector-privacy-ready" data-checked={brief.privacyReady}><input id="sector-privacy-ready" type="checkbox" checked={brief.privacyReady} onChange={(event) => updateBrief("privacyReady", event.target.checked)} /><span><b>Privacidad preparada</b><small>Responsable, consentimiento, textos y conservación definidos.</small></span></label>
              <label aria-label="Entrega operativa validada" htmlFor="sector-delivery-ready" data-checked={brief.deliveryReady}><input id="sector-delivery-ready" type="checkbox" checked={brief.deliveryReady} onChange={(event) => updateBrief("deliveryReady", event.target.checked)} /><span><b>Entrega operativa validada</b><small>SLA, CRM, rechazo, remedio y capacidad aceptados.</small></span></label>
            </div>
